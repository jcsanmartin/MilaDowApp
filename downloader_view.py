...
def get_downloader_view(page: ft.Page):
    config = load_config()
    ...
    playlist_limit_input = ft.TextField(label="Máx Videos", value="50", width=100, keyboard_type=ft.KeyboardType.NUMBER)
